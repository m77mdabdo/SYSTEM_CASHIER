		...
		<div class="container-fluid">
			<form action="" id="menu-form">
				...
				<div class="form-group">
					...
					<input type="text" name="category_id" id="category_id" class="form-control form-control-sm rounded-0" value="<?php echo isset($category_id) ? $category_id : ''; ?>" required />
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<input type="number" name="price" id="price" class="form-control form-control-sm rounded-0" value="<?php echo isset($price) ? $price : ''; ?>" required />
				</div>
				<div class="form-group">
	...
	<script>
		$(document).ready(function() {
			$('#menu-form').submit(function(e) {
				...
				start_loader();
				$.ajax({
					url: _base_url_ + "menu/createMenu",
